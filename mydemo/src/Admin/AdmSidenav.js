...
const AdmSidenav = () => {
  ...
  <span> <i style={{"font-size":"20px","color":"white"}} class="fa" data-toggle="tooltip" data-placement="bottom" title="Light mode">&#xf185;</i></span> 
   &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
  {/* <span> <i style={{"font-size":"20px","color":"white"}} class="fa" data-toggle="tooltip" data-placement="bottom" title="Notification">&#xf0f3;</i></span>  */}
  &nbsp;&nbsp;&nbsp;&nbsp;
    {/* <span><i style={{"font-size":"23px","color":"white"}} class="fa" data-toggle="tooltip" data-placement="bottom" title="Setting">&#xf013;</i></span> */}
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <Link to="/admprofile"> <span><i style={{"font-size":"33px","color":"white"}} class="fa" data-toggle="tooltip" data-placement="right" title="Edit Profile">&#xf2be;</i></span></Link>
  </div>
</nav>
    </>
  )
